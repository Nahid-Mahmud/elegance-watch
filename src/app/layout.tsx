...
export const metadata: Metadata = {
  title: "Heritage Luxury Watch",
  description:
    "Experience timeless elegance and precision craftsmanship with our exclusive collection of luxury watches, blending classic design with modern innovation.",
};
