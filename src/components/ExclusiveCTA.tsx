    ...
    <section ref={container} className="relative h-screen bg-black flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-10 max-w-5xl border border-white/5 bg-white/5 backdrop-blur-3xl py-32 rounded-[4rem]">
        ...
        <p className="text-zinc-500 text-lg md:text-3xl font-light mb-16 max-w-2xl mx-auto leading-relaxed">
            The 2026 Batch is limited to 100 timepieces. 
            Secure your place in the waitlist.
        </p>
        
        <div className="flex flex-col md:flex-row items-center justify-center gap-6">
            <button className="px-16 py-6 bg-white text-black font-semibold uppercase tracking-[0.3em] text-xs hover:bg-blue-500 hover:text-white transition-all duration-500">
                Reserve Yours
            </button>
            <button className="px-16 py-6 border border-white/20 text-white font-semibold uppercase tracking-[0.3em] text-xs hover:border-blue-500 transition-all duration-500">
                Contact Concierge
            </button>
        </div>
